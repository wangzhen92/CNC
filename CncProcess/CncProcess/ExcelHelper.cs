...
namespace CncProcess
{
    ...
    public class ExcelHelper : IDisposable
    {
        ...
        public static DataTable CreateDataTable()
        {
            ...
            dataTable.Columns.Add("sprev");
            dataTable.Columns.Add("spload1");
            dataTable.Columns.Add("spload2");
            dataTable.Columns.Add("spload3");
            dataTable.Columns.Add("spload4");
            return dataTable;
        }

        public static void CreatExcelFile(string file) {
        ...
        {
            CreatExcelFile(TargetFileNamePath);
